...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'stage': //Week 1
				...
				case 'streetsDay': //Week 7
				var bg:BGSprite = new BGSprite('City/streetsDay', -600, -200, 0.9, 0.9);
				add(bg);

				case 'streetsNight': //Week 7
				var bg:BGSprite = new BGSprite('City/streetsNight', -600, -200, 0.9, 0.9);
				add(bg);

				case 'streetsSunset': //Week 7
				var bg:BGSprite = new BGSprite('City/streetsSunset', -600, -200, 0.9, 0.9);
				add(bg);

				case 'stars': //Week 7
				var bg:BGSprite = new BGSprite('City/stars', -600, -200, 0.9, 0.9);
				add(bg);
	...
	override function stepHit()
	{
		...
		if(curSong == 'happy-days')
		{
		  if (curStep == 128)
		  {
		    curStage = 'streets';
			FlxG.camera.flash(FlxColor.RED, 1.6, false);
			 }
		   }
			...
			if(!Achievements.achievementsUnlocked[arrayIDs[i]][1]) {
				switch(arrayIDs[i]) {
					case 1 | 2 | 3 | 4 | 5 | 6 | 7:
						...
						storyPlaylist.length <= 7 && WeekData.getWeekFileName() == ('week' + arrayIDs[i]) && !changedDifficulty && !usedPractice) {
